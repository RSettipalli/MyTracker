  ...
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logoSmallTitle"><a href="#"><img src="images/mygologo_icon.jpg" width=50 border="0"></a>
       ...
       <a href="#"><img src="images/Registeration.png" width=50 border="0"></a>
      </div>
      <div class="clr"></div>
<!-- Shipping
Orders
...
Resources -->
  ...
  <div class="content">
    <div class="content_resize"> <img src="images/mygologo.jpg" width="948"  alt="" class="hbg_img" />
      <div class="clr"></div>
      <div class="mainbar">
        <div class="article">
          <h2><span>Shipping</h2>
	  ...
	  <p> Test text</p>
          <ul class="sb_menu">
            <li><a href="#"><strong>Test Link</strong></a></li>
            <li><a href="#"><strong>Test Link</strong></a></li>
            <li><a href="#"><strong>Test Link</strong></a></li>
            <li><a href="#"><strong>Test Link</strong></a></li>
            <li><a href="#"><strong>Test Link</strong></a></li>
