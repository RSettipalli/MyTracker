    ...
    <div class="content_resize">
      ...
      <div class="mainbar">
        ...
        <br/>
          ...
          <display:table name="salesOrderHeader" cellspacing ="12" style="border:solid 1px;"  id="current_row">
          	<display:column property="ORDER_NBR" title="OrderNumber"/>
  			<display:column property="ORDER_TYPE" title="Type"/>
  			...
  			<display:column property="ORDER_NBR_VER" title="Version"/>  			
 	   ...
 	   <br />
 	   <div class="content">
 	   <b> <u>Sales Order Header Comments</u> </b> <br/>
 	   <display:table name="salesOrderHeaderComments" cellspacing ="12" style="border:solid 1px;" >
          	<display:column property="ORDER_NBR" title="OrderNumber"/>
 	  ...
 	  <display:table name="soDetail" style="border:solid 1px;" cellspacing="10">
 	   ...
 	   <br />
   	 <div class="content">
   	 <b> <u>Sales Order Detail Comments</u> </b> <br/>
 	   <display:table name="soDetailComments" cellspacing ="12" style="border:solid 1px;" >
          	<display:column property="ORDER_NBR" title="OrderNumber"/>
          	<display:column property="ORDER_LINE_NBR" title="OrderLineNumber"/>
  			<display:column property="LINE" title="Line"/>
  			<display:column property="TYPE" title="Type"/>
 	   ...
 	   <br />
       <div class="content">
       <b> <u>Sales Order Item Attachments</u> </b> <br/>
 	   <display:table name="soDetailItemAttachments" cellspacing ="12" style="border:solid 1px;" >
